...
The graphical user interface was tested with the same input scenarios described in Section 3.2. Figures~\ref{fig:gui_test1} through~\ref{fig:gui_test6} show the GUI output for each test case.
